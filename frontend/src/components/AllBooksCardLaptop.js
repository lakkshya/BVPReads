...
const AllBooksCardLaptop = ({ book, user, isBookAddedToBag, handleAddToBag, bookCount }) => {
    ...
    return (
        <div className="col-12 book-card d-flex align-items-start">
            <div className="col-lg-4 d-flex align-items-start me-2">
                <span className="my-font">{book.title}</span>
            </div>
            <div className="col-lg-4 d-flex align-items-start me-2">
                <span className="my-font">{book.author}</span>
            </div>
            <div className="col-lg-2 d-flex align-items-start me-2">
                <span className="my-font">{book.category}</span>
            </div>
            <div className="col-lg-2 d-flex align-items-start justify-content-center">
                {!addedToBag && (
...
export default AllBooksCardLaptop;